...
@RestController
@RequestMapping("task")
public class TaskController implements TodoControllerDocs {
    ...
    @GetMapping("all")
    @RolesAllowed("ADMIN")
    public ResponseEntity<List<TaskResponse>> getAll(@RequestParam(required = false) Optional<StatusTaskEnum> status) {
